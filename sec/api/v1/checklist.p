...
procedure pi-find:
    ...
    if upper(return-value) = "OK":U then do:
        ...
        msg:add("ErrorHelp", "Checklist n∆o encontrado na base de dados!").
        msg:add("ErrorNumber", 1).
        msg:add("ErrorDescription", "Checklist n∆o encontrado!").
...
procedure pi-list:
    ...
    run getBatchRecords in boHandler( 
        ...
        output table ttChecklist //parÉmetro de entrada, que contÇm o handle da temp-table onde ser∆o retornados os registros
        ). 
